<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mari_Bid.aspx.cs" Inherits="TheSpadesGameJACK.Mari_Bid" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" BackColor="green" Font-Bold="True" Height="200px" Width="400px" >
            <h1>Choose a Bid</h1>
            <div id="Button">
            <asp:Button ID="Button14" runat="server" BackColor="#FFFF66" BorderColor="Black" Font-Size="Large" ForeColor="Black" Height="52px" OnClick="Button1_Click" Text="0" Width="52px" />
            <asp:Button ID="Button1" runat="server" Text="1" BackColor="#FFFF66" BorderColor="Black" Font-Size="Large" ForeColor="Black" Height="52px" Width="52px" OnClick="Button1_Click" />
            <asp:Button ID="Button2" runat="server" BackColor="#FFFF66" BorderColor="Black" Font-Size="Large" ForeColor="Black" Height="52px" OnClick="Button2_Click" Text="2" Width="52px" />
